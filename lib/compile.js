...
var compileTemplate = function(objName, templateName, contents, quoteChar, indentString, useStrict, htmlmin) {
  ...
  var result = objName + '[\'' + templateName + '\'] = ' +
...
module.exports = function(file, options, callback) {
  ...
  function getModule(filepath) {
    ...
    if (options.target === 'js') {
      return compileTemplate(options.objName, templateName, file.contents.toString(), options.quoteChar, options.indentString, options.useStrict, options.htmlmin);
    } else {
